...
<div id="contador">
  <h1>Pediste el servicio Bite by Félix</h1>
  <p>¡Tiempo maximo restante antes de que el servicio 0800 bitstp llegue!</p>
  <p id="tiempo-restante">16h 45m 00s</p>
</div>
...
function mettreAJourCompteRebours() {
  ...
  finJournee.setHours(16, 45, 0, 0); // Réglage de l'heure à 16h45
